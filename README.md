...
## Research and Machine Learning Notebooks
  ...
  * Humpback Whales
      * [Humpback whale song detection 🐳](https://github.com/danellecline/pacific-sound-notebooks/blob/master/humpbackwhales/detect/PacificSoundDetectHumpbackSong.ipynb) Detect humpback song with a neural network model
  * Shipping Noise
